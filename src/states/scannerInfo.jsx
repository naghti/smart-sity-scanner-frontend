...
class ScannerInfo {
    ...
    info = {
        ...
        admin:{
            ...
            paragraph: "Данный раздел позволяет актуализировать статус Данный раздел позволяет актуализировать статус внедрения существующих цифровых инструментов и создать дорожную карту цифровой трансформации",
